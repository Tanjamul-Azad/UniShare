...
frontend preview: https://unishare-app.vercel.app/
...
3. The frontend talks to the backend through the Vite dev proxy, so `VITE_API_URL` can be left as `/api` in `frontend/.env` during local development.
