      ...
      <div className="mx-auto max-w-5xl px-1 sm:px-0">
        ...
        >
          ...
          <p className="mt-2 text-slate-600">
            Stay on top of order updates, messages, and group events.
          </p>
        </motion.div>
          ...
          {sortedNotifications.length === 0 ? (
            <div className="p-10 text-center">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Try switching filters to see more updates.
              </p>
            </div>
          ) : (
            <ul className="divide-y divide-slate-100">
              {sortedNotifications.map((notification, index) => (
                ...
                >
                  <div
                    className={`mt-1 rounded-full p-2 ${!notification.read ? "bg-white shadow-sm" : "bg-slate-100"}`}
                  >
                  ...
                  <div className="min-w-0 flex-1">
                    <p
                      className={`text-sm ${!notification.read ? "font-semibold text-slate-900" : "font-medium text-slate-800"}`}
                    >
                      {notification.title}
                    </p>
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      <Link
                        to={
                          ...
                          getNotificationTarget(notification.type)
                        }
